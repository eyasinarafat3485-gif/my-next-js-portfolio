...
//     const introductoryText = " Hi Everyone, This is Eyasin Arafat — a Full Stack Developer. My love for technology goes beyond profession; it is a part of who I am. On the frontend, I weave responsive and vibrant user interfaces using React, JavaScript, Tailwind CSS and also Elementor, Plugins—where beauty is not just seen, but felt."

//     const hiddenText = "On the backend, I build a strong foundation with Node.js and Express.js, creating a secure and high-performance ecosystem that brings together RESTful APIs, JWT authentication and WebSockets. I don't just write code—I fight against threats like XSS, control traffic with rate limiting to prepare applications for takeoff on a production-ready platform. I ensure an SEO-friendly structure in every project, helping them rank higher in search engines. To me, every project is like a living entity—where the elegance of the frontend and the power of the backend come together in perfect harmony. My goal is not just to build applications, but to create fast, secure, and user-friendly web experiences that touch people's lives, grow businesses, and make the digital world more beautiful, faster, and more reliable.Passionate about transforming design concepts into seamless, scalable WordPress solutions with a strong focus on clean code and user experience."
...
import darkWork from '../../assets/darkmode.png'
import Image from 'next/image';
// Framer Motion ইমপোর্ট করা হয়েছে
...
const AboutMe = () => {
    ...
    const containerVariants = {
        ...
        visible: {
            opacity: 1,
            transition: { staggerChildren: 0.1 } // প্রতিটি আইটেম একের পর এক আসবে
        }
    };
        ...
        >
            <div className="w-full mx-auto flex flex-col lg:flex-row gap-12 items-start">
                ...
                <motion.div variants={fadeInLeft} className="w-full lg:w-1/3 flex flex-col items-center lg:items-start ">
                    {/* Illustration Image */}
                    <div className="w-full overflow-hidden rounded-tl-3xl rounded-tr-3xl md:rounded-tr-sm md:rounded-tl-3xl">
                        {/* Light Mode Image */}
                        <Image
                            src={lightWork}
                            alt="Developer Illustration"
                ...
                <motion.div variants={fadeInRight} className="w-full lg:w-2/3 md:pr-10 ">
                    <div className="w-fit">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="h-0.5 mb-4 md:mb-8 bg-red-500 mx-auto md:mx-4"
                        ></motion.div>
                    </div>
