  ...
  return (
    <nav className='bg-red-100 sticky top-0 z-50 shadow-sm'>
      <div className='flex justify-between items-center max-w-7xl mx-auto p-5 relative'>
        ...
        <ul className={`
          md:hidden absolute right-3 w-35 bg-white border border-red-100 p-2 flex flex-col gap-1 shadow-xl rounded-xl transition-all duration-300 ease-in-out z-50
