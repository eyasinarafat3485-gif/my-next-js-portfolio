    ...
    {[
      {
        icon: <FaLinkedinIn />,
        label: "LinkedIn",
        link: "https://www.linkedin.com/in/md-eyasin-arafat-webdev",
        color: "#0A66C2",
      },
      {
        icon: <FaGithub />,
        label: "GitHub",
        link: "https://github.com/eyasinarafat3485-gif",
        color: "#181717",
      },
      {
        icon: <FaFacebookF />,
        label: "Facebook",
        link: "https://www.facebook.com/eyasinarafatwebdev12",
        color: "#1877F2",
      },
      {
        icon: <MdEmail />,
        label: "Email",
        link: "mailto:eyasinwebdev@gmail.com",
        color: "#EA4335",
      },
    ].map((social, i) => (
      <a
