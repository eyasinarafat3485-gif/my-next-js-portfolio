...
const DownloadButton = () => {
    ...
    return (
        <motion.button onClick={() => handleDownloadCv()} initial="initial" whileHover="hover" animate="initial"
            className="group relative cursor-pointer flex items-center gap-3 px-8 py-3 bg-[#EF4444] text-white font-semibold rounded-full border-2 border-[#EF4444] overflow-hidden transition-colors duration-300 shadow-lg" >
