...
const DownloadButton = () => {
    ...
    return (
        <motion.button onClick={() => handleDownloadCv()} initial="initial" whileHover="hover" animate="initial"
            className="group relative cursor-pointer flex items-center gap-3 px-5.5 py-3 bg-red-500 text-white font-bold text-[17px]  rounded-full border-2 border-red-500 overflow-hidden transition-colors duration-300 shadow-lg" >
